...
int main()
{
    ...
    for (int i = 0; i < 50; ++i)
    {
        ...
        std::vector<byte_t> test_bytes, decoded_bytes;
        ...
        try
        {
            ...
            encoded_str = base64::encode(test_bytes.begin(), test_bytes.end());
            ...
            try
            {
                decoded_bytes = base64::decode<byte_t>(ans_str);
            }
